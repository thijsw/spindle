...
let package = Package(
    ...
    targets: [
        ...
        .executableTarget(
            name: "spindle-cli",
            dependencies: ["DiscDrive", "Metadata", "RipEngine", "Encoding", "Naming", "Verification"]
        ),
        ...
        .executableTarget(
            name: "spindle-tests",
            dependencies: ["DiscDrive", "Metadata", "RipEngine", "Encoding", "Naming", "Verification", "SpindleCore"]
        ),
    ]
)
